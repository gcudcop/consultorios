...
public class Control_Mozarela {
  ...
  private Double rendimiento_mozarela;
    ...
    public Control_Mozarela(Integer id_control_mozarela, Integer id_producto, String ph_mozarela, String humedad_mozarela, String cenizas_mozarela, Double grasas_mozarela, Double proteinas_mozarela, Double solidos_totales, Double rendimiento_mozarela) {
